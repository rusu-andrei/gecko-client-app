const Lemon = ({cy}) => {
  return (
    ...
    >
      <circle cx="18" cy="-100" r="4" fill="white"></circle>
      {/* <path
      ...
      ></path>
      <path
        d="M18 69.28815667547082 C15 69.28815667547082 16 69.28815667547082 12 61L9 56C2 33 62 -3 80 12C103 27 44 56 29 58C27 58 25 59 24 61C20 69.28815667547082 21 69.28815667547082 18 69.28815667547082Z"
        fill="white"
      ></path>
      <path
